...
public class PlayerMovementSimple : MonoBehaviour
{
    ...
    {
        yield return null;
        maxDistane = PlayerDataSimple.Instance.maxDistance;
        dashDuration = PlayerDataSimple.Instance.dashDuration;
        dashInterval = PlayerDataSimple.Instance.dashInterval;
    }
